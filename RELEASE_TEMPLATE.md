...
change note - keep it plain prose (not Markdown). -->
...
This section of the release notes is only relevant to developers working on the Safe Space addon or creating extensions for it.

<!-- Changes relevant to extension/addon developers. -->

**Full Changelog**: https://github.com/AmyJeanes/Safe-Space/compare/PREVIOUS_TAG...NEW_TAG
